...
import (
	...
	"github.com/iangregsondev/deblockprocessor/internal/solana/blockprocessor/di"
...
func main() {
	...
	appName := "solana-block-processor"
	...
	var rootCmd = &cobra.Command{
		Use:          "solana-block-processor",
		Short:        "Solana block processor",
		SilenceUsage: true,
