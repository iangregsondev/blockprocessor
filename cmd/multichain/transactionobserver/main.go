...
import (
	...
	"github.com/iangregsondev/deblockprocessor/internal/multichain/transactionobserver/di"
...
func main() {
	...
	appName := "multichain-transaction-observer"
	...
	var rootCmd = &cobra.Command{
		Use:          "multichain-transaction-observer",
		Short:        "Multi chain transaction observer",
		SilenceUsage: true,
